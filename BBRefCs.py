...
stat_columns = ['MIN', 'FG', 'FGA', '3P', '3PA', 'FT', 'FTA', 'OR', 'DR', 'TOT', 'A', 'PF', 'ST', 'TO', 'BL', 'PTS']
...
per_game_averages['SCORE'] = (
    ...
    per_game_averages['DR'] * weights['REB'] +
    per_game_averages['OR'] * weights['REB'] +
    per_game_averages['A'] * weights['A'] +
    per_game_averages['BL'] * weights['BLK'] +
    per_game_averages['ST'] * weights['STL'] +
...
per_game_averages.to_excel('Center_Per_Game_Averages_with_Score.xlsx', index=False)
